...
class BinarySearchTest < Minitest::Test
  ...
  def test_it_finds_position_of_search_data
    ...
    assert_equal 5, binary.search_for_recursive(9)
  end
  ...
  def test_it_finds_position_in_a_larger_list
    ...
    assert_equal 1, binary.search_for_recursive(3)
    assert_equal 7, binary.search_for(55)
    assert_equal 7, binary.search_for_recursive(55)
  end
  ...
  def test_it_finds_correct_position_in_a_list_with_an_even_number_of_elements
    ...
    assert_equal 5, binary.search_for_recursive(21)
    assert_equal 6, binary.search_for(34)
    assert_equal 6, binary.search_for_recursive(34)
  end
end
